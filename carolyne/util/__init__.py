...
# fact both of them ask (is this a power of two?) has nowhere else to go.
#
# `uarch/common/` stays where uarch-only arithmetic is (ceil_log2, the word
# readers). A helper belongs HERE only when `isa/` asks it too.
